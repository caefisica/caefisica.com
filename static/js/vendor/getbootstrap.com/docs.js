      ...
      (this.add = function (k) {
        ...
        for (
          null === document.head.querySelector("style.anchorjs") &&
            ...
            void 0 === (k = document.head.querySelector('[rel="stylesheet"],style'))
          ...
          if (this.hasAnchorJSLink(e[c])) l.push(c);
            ...
            if (e[c].hasAttribute("id")) h = e[c].getAttribute("id");
              ...
              for (
                ...
                (i = o.indexOf((g = void 0 !== i ? p + "-" + n : g))), (n += 1), -1 !== i;
              );
      ...
      (this.remove = function (f) {
        for (var d, e, c = b(f), a = 0; a < c.length; a++)
          (e = c[a].querySelector(".anchorjs-link")) &&
            (-1 !== (d = this.elements.indexOf(c[a])) && this.elements.splice(d, 1),
            c[a].removeChild(e));
        return this;
      }),
        ...
        134: function (p, a, b) {
          ...
          function o(a) {
            ...
            return function () {
              ...
              return (
                (e = b
                  ? ((e = d(this).constructor), Reflect.construct(f, arguments, e))
              ...
              b =
                "SELECT" === a.nodeName
                  ...
                  : "INPUT" === a.nodeName || "TEXTAREA" === a.nodeName
                    ? ((c = a.hasAttribute("readonly")) || a.setAttribute("readonly", ""),
                      a.select(),
      ...
      window.docsearch({
        ...
        transformData: function (a) {
          return a.map(function (a) {
            ...
            return (
              (a.url = window.location.origin.startsWith(b) ? a.url : a.url.replace(b, "/")),
              a.anchor === "content" &&
