    ...
    return (() => {
      var e = {
          948: (e, t, r) => {
            ...
            function J(e) {
              var t = e.event,
                ...
                c = e.store,
                l = H(e, R);
              W && u.environment.clearTimeout(W);
              ...
              return (
                m("loading"),
                (W = u.environment.setTimeout(function () {
                  m("stalled");
                }, u.stallThreshold)),
                V(
                  u
                  ...
                  .then(function (e) {
                    var r;
                    if ((m("idle"), c.shouldSkipPendingUpdate))
                      V.isRunning() || (c.shouldSkipPendingUpdate = !1);
                    else {
                      s(e);
            ...
            J.isRunning = V.isRunning;
            var Q = ["event", "props", "refresh", "store"];
            function $(e, t) {
              var r = Object.keys(e);
              if (Object.getOwnPropertySymbols) {
                var n = Object.getOwnPropertySymbols(e);
            ...
            var X = ["props", "refresh", "store"],
              Y = ["inputElement", "formElement", "panelElement"],
              Z = ["inputElement"],
              ee = ["inputElement", "maxLength"],
              te = ["item", "source"];
            function re(e, t) {
              var r = Object.keys(e);
              if (Object.getOwnPropertySymbols) {
                  ...
                  return ne(
                    {
                      onTouchStart: function (e) {
                        (!1 === n.getState().isOpen && !J.isRunning()) ||
                          e.target === r ||
                          (!1 ===
                            [u, o].some(function (t) {
                            ...
                            !t.debug && J.isRunning() && (n.shouldSkipPendingUpdate = !0)));
                      },
                      ...
                      onKeyDown: function (e) {
                        !(function (e) {
                          ...
                          if ("ArrowUp" === t.key || "ArrowDown" === t.key) {
                            ...
                            (t.preventDefault(),
                              u.dispatch(t.key, null),
                              J.isRunning() && (u.shouldSkipPendingUpdate = !0));
                          else if ("Enter" === t.key) {
                            if (
            ...
            var ae = "1.5.1",
              ce = [{ segment: "autocomplete-core", version: ae }];
            function le(e, t) {
              var r = Object.keys(e);
              if (Object.getOwnPropertySymbols) {
                var n = Object.getOwnPropertySymbols(e);
            ...
            function fe(e) {
              var t,
                ...
                a =
                  null ===
                    (t = ((null === (r = i.__autocomplete_metadata) || void 0 === r
                      ? void 0
              ...
              return {
                ...
                options: se({ "autocomplete-core": Object.keys(i) }, c),
                ua: ce.concat(
            ...
            var ye = function (e, t) {
              switch (t.type) {
                case "setActiveItemId":
                  return he(he({}, e), {}, { activeItemId: t.payload });
                case "setQuery":
                  return he(he({}, e), {}, { query: t.payload, completion: null });
                case "setCollections":
                  return he(he({}, e), {}, { collections: t.payload });
                case "setIsOpen":
                  return he(he({}, e), {}, { isOpen: t.payload });
                case "setStatus":
                  return he(he({}, e), {}, { status: t.payload });
                case "setContext":
                  return he(
                    he({}, e),
                    {},
                  ...
                  var r = he(
                    ...
                    {},
                    {
                      activeItemId: t.payload.hasOwnProperty("nextActiveItemId")
                        ...
                        : me(1, e.activeItemId, s(e), t.props.defaultActiveItemId),
                    },
                  );
                  return he(he({}, r), {}, { completion: de({ state: r }) });
                case "ArrowUp":
                  var n = he(
                    he({}, e),
                    {},
                    {
                      activeItemId: me(-1, e.activeItemId, s(e), t.props.defaultActiveItemId),
                    },
                  );
                  return he(he({}, n), {}, { completion: de({ state: n }) });
                case "Escape":
                  return e.isOpen
                    ? he(
                        he({}, e),
                ...
                default:
                  return (
                    "The reducer action ".concat(JSON.stringify(t.type), " is not supported."), e
                  );
              }
            };
            function ge(e, t) {
            ...
            function Oe(e) {
              var t = [],
                ...
                a = ie(be({ props: r, refresh: l, store: n }, u));
              function l() {
                return J(
                  be(
                    {
            ...
            function Se(e, t, r) {
              ...
              if ("style" === t)
                ...
                else for (t in r) (o && r[t] === o[t]) || je(e.style, t, r[t]);
              else
                "o" === t[0] && "n" === t[1]
                  ? ((n = t !== (t = t.replace(/Capture$/, ""))),
                    ...
                    (e._listeners[t] = r),
                    r ? o || e.addEventListener(t, we, n) : e.removeEventListener(t, we, n))
                  : "list" !== t &&
                      "tagName" !== t &&
                      "form" !== t &&
                      "type" !== t &&
            ...
            function Ie(e, t) {
              for (var r in t) Se(e, Be(r), t[r]);
            }
            function ke(e, t) {
              for (var r in t) ("o" === r[0] && "n" === r[1]) || Se(e, Be(r), t[r]);
            }
            var xe = ["children"];
            function Ne(e) {
              return (
            ...
            function Re(e) {
              return function (t, r) {
                ...
                return (Ie(i, o), i.append.apply(i, Ne(u)), i);
              };
            }
            var Le = [
            ...
            function $e(e) {
              var t = e.autocomplete,
                ...
                p = e.translations,
                f = Re(u),
                d = c.getRootProps(Je({ state: s, props: t.getRootProps({}) }, r)),
                m = f("div", Je({ class: n.root }, d)),
                v = f("div", {
                ...
                y = f("button", {
                  ...
                  children: [Ce({ environment: u })],
                }),
                g = f("label", Je({ class: n.label, children: [y] }, D)),
                b = f("button", {
                  class: n.clearButton,
                  type: "reset",
                  title: p.clearButtonTitle,
                  children: [Fe({ environment: u })],
                }),
                _ = f("div", {
                  class: n.loadingIndicator,
                  children: [Pe({ environment: u })],
                }),
                O = (function (e) {
                ...
                P = f("form", Je({ class: n.form, children: [A, C, E] }, F)),
                j = c.getPanelProps(
                  Je(
                    {
                      state: s,
            ...
            var ze,
              ...
              Ye = {},
              Ze = [],
              et = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
            function tt(e, t) {
            ...
            function nt(e, t, r) {
              ...
              return ut(e, a, n, u, null);
            }
            function ut(e, t, r, n, u) {
              var o = {
                type: e,
                props: t,
                key: r,
              ...
              return (null != ze.vnode && ze.vnode(o), o);
            }
            function ot(e) {
              return e.children;
            }
            ...
            function lt(e) {
              ((!e.__d && (e.__d = !0) && Ke.push(e) && !st.__r++) ||
                Xe !== ze.debounceRendering) &&
                ((Xe = ze.debounceRendering) || Ge)(st);
            }
            function st() {
              for (var e; (st.__r = Ke.length); )
            ...
            function pt(e, t, r, n, u, o, i, a, c, l) {
              var s,
                p,
                f,
                d,
              ...
              for (r.__k = [], s = 0; s < t.length; s++)
                if (
                  ...
                  (d = r.__k[s] =
                    null == (d = t[s]) || "boolean" == typeof d
                      ...
                      : "string" == typeof d || "number" == typeof d || "bigint" == typeof d
                        ...
                        : Array.isArray(d)
                          ? ut(ot, { children: d }, null, null, null)
                          : d.__b > 0
                            ? ut(d.type, d.props, d.key, null, d.__v)
                            : d)
                ) {
                  if (
                    ((d.__ = r),
                    (d.__b = r.__b + 1),
                    null === (f = D[s]) || (f && d.key == f.key && d.type === f.type))
                  )
                    D[s] = void 0;
                  else
                    for (p = 0; p < y; p++) {
                  ...
                  (yt(e, d, (f = f || Ye), u, o, i, a, c, l),
                    (m = d.__e),
                    (p = d.ref) &&
                      f.ref != p &&
                      (h || (h = []), f.ref && h.push(f.ref, null, d), h.push(p, d.__c || m, d)),
                    null != m
                      ? (null == v && (v = m),
                        ...
                        l || "option" !== r.type
                          ...
                          : (e.value = ""))
                      : c && f.__e == c && c.parentNode != e && (c = at(f)));
                }
              for (r.__e = v, s = y; s--; )
                null != D[s] &&
                  ("function" == typeof r.type &&
                    ...
                    (r.__d = at(n, s + 1)),
                  Ot(D[s], D[s]));
              if (h) for (s = 0; s < h.length; s++) _t(h[s], h[++s], h[++s]);
            }
            function ft(e, t, r) {
              var n, u;
              for (n = 0; n < e.__k.length; n++)
                (u = e.__k[n]) &&
                  ((u.__ = e),
                  (t = "function" == typeof u.type ? ft(u, t, r) : dt(r, u, u, e.__k, u.__e, t)));
              return t;
            }
            ...
            function mt(e, t, r) {
              "-" === t[0]
                ? e.setProperty(t, r)
                : (e[t] = null == r ? "" : "number" != typeof r || et.test(t) ? r : r + "px");
            }
              ...
              e: if ("style" === t)
                if ("string" == typeof r) e.style.cssText = r;
                  ...
                  if (("string" == typeof n && (e.style.cssText = n = ""), n))
                    for (t in n) (r && t in r) || mt(e.style, t, "");
                  if (r) for (t in r) (n && r[t] === n[t]) || mt(e.style, t, r[t]);
                }
              else if ("o" === t[0] && "n" === t[1])
                ((o = t !== (t = t.replace(/Capture$/, ""))),
                  ...
                  (e.l[t + o] = r),
                  r
                    ? n || e.addEventListener(t, o ? Dt : ht, o)
                    : e.removeEventListener(t, o ? Dt : ht, o));
            ...
            function yt(e, t, r, n, u, o, i, a, c) {
              ...
              (null != r.__h && ((c = r.__h), (a = t.__e = r.__e), (t.__h = null), (o = [a])),
                (l = ze.__b) && l(t));
              try {
                e: if ("function" == typeof b) {
                  if (
                    ...
                    r.__c
                      ...
                      : ("prototype" in b && b.prototype.render
                          ? (t.__c = s = new b(h, y))
                          : ((t.__c = s = new it(h, y)), (s.constructor = b), (s.render = At)),
                        D && D.sub(s),
                        (s.props = h),
                        s.state || (s.state = {}),
                        (s.context = y),
                    ...
                    null != b.getDerivedStateFromProps &&
                      (s.__s == s.state && (s.__s = tt({}, s.__s)),
                      tt(s.__s, b.getDerivedStateFromProps(h, s.__s))),
                    (f = s.props),
                    (d = s.state),
                    p)
                  )
                  ...
                  ((s.context = y),
                    ...
                    (s.state = s.__s),
                    null != s.getChildContext && (n = tt(tt({}, n), s.getChildContext())),
                    p || null == s.getSnapshotBeforeUpdate || (m = s.getSnapshotBeforeUpdate(f, d)),
                    (g = null != l && l.type === ot && null == l.key ? l.props.children : l),
                    pt(e, Array.isArray(g) ? g : [g], t, r, n, u, o, i, a, c),
                    (s.base = t.__e),
                    (t.__h = null),
                    s.__h.length && i.push(s),
                    v && (s.__E = s.__ = null),
                  ...
                  null == o && t.__v === r.__v
                    ...
                    : (t.__e = bt(r.__e, t, r, n, u, o, i, c));
                (l = ze.diffed) && l(t);
              } catch (e) {
                ((t.__v = null),
                  (c || null != o) && ((t.__e = a), (t.__h = !!c), (o[o.indexOf(a)] = null)),
                  ze.__e(e, t, r));
              }
            }
            function gt(e, t) {
            ...
            function bt(e, t, r, n, u, o, i, a) {
              ...
              if (null === m) f === d || (a && e.data === d) || (e.data = d);
                ...
                if (
                  ((o = o && Ze.slice.call(e.childNodes)),
                  (l = (f = r.props || Ye).dangerouslySetInnerHTML),
                ...
                if (
                  ((function (e, t, r, n, u) {
                    var o;
                    for (o in r)
                      "children" === o || "key" === o || o in t || vt(e, o, null, r[o], n);
                    for (o in t)
                  ...
                  for (v = o.length; v--; ) null != o[v] && rt(o[v]);
                a ||
                  ("value" in d &&
                    void 0 !== (v = d.value) &&
                    (v !== e.value || ("progress" === m && !v)) &&
                    vt(e, "value", v, f.value, !1),
                  "checked" in d &&
                    void 0 !== (v = d.checked) &&
                    v !== e.checked &&
                    vt(e, "checked", v, f.checked, !1));
              }
              return e;
            }
            function _t(e, t, r) {
            ...
            function Ot(e, t, r) {
              var n, u, o;
              if (
                (ze.unmount && ze.unmount(e),
                (n = e.ref) && ((n.current && n.current !== e.__e) || _t(n, null, t)),
              ...
              if ((n = e.__k)) for (o = 0; o < n.length; o++) n[o] && Ot(n[o], t, r);
              null != u && rt(u);
            }
            function At(e, t, r) {
            ...
            function Et(e, t, r) {
              ...
              (ze.__ && ze.__(e, t),
                ...
                yt(
                  t,
                  (e = ((!n && r) || t).__k = nt(ot, null, [e])),
                  u || Ye,
                  Ye,
                  void 0 !== t.ownerSVGElement,
                  !n && r ? [r] : u ? null : t.firstChild ? Ze.slice.call(t.childNodes) : null,
                  o,
            ...
            ((ze = {
              ...
              (it.prototype.setState = function (e, t) {
                ...
                ((r =
                  ...
                  "function" == typeof e && (e = e(tt({}, r), this.props)),
                  e && tt(r, e),
                  null != e && this.__v && (t && this.__h.push(t), lt(this)));
              }),
            ...
            function jt(e) {
              var t = e.highlightedValue.split(Ft),
                r = t.shift(),
                n = (function () {
            ...
            function Bt(e) {
              var t = e.hit,
                ...
                u = Ct(t, ["_highlightResult"].concat(wt(n), ["value"]));
              return ("string" != typeof u && (u = Ct(t, n) || ""), jt({ highlightedValue: u }));
            }
            var It = {
                "&amp;": "&",
                "&lt;": "<",
            ...
            function Mt(e) {
              return e.some(function (e) {
                ...
                ? e.map(function (t, r) {
                    return Rt(Rt({}, t), {}, { isHighlighted: !Tt(e, r) });
                  })
                : e.map(function (e) {
                    return Rt(Rt({}, e), {}, { isHighlighted: !1 });
                  });
            }
            function Ut(e) {
              ...
              return function (e) {
                ...
                return t(
                  r,
                  {},
                  ((n = { hit: u, attribute: o }), Mt(Bt(n))).map(function (e, r) {
            ...
            function Vt(e) {
              var t = e.hit,
                r = e.attribute,
                n = Array.isArray(r) ? r : [r],
                u = Ct(t, ["_snippetResult"].concat(Ht(n), ["value"]));
              return ("string" != typeof u && (u = Ct(t, n) || ""), jt({ highlightedValue: u }));
            }
            function Jt(e) {
              var t = e.createElement,
              ...
              return function (e) {
                ...
                return t(
                  r,
                  {},
                  ((n = { hit: u, attribute: o }), Mt(Vt(n))).map(function (e, r) {
                    return e.isHighlighted ? t(a, { key: r }, e.value) : e.value;
                  }),
                );
              };
            ...
            function Qt(e) {
              ...
              return function (e) {
                ...
                return t(
                  r,
                  {},
                  Vt({ hit: n, attribute: u }).map(function (e, r) {
                    return e.isHighlighted ? t(i, { key: r }, e.value) : e.value;
                  }),
                );
              };
            }
            ...
            var er = {
              ...
              rr = { createElement: nt, Fragment: ot };
            function nr(e) {
            ...
            var cr = [{ segment: "autocomplete-js", version: ae }];
            function lr(e) {
              return (
                (function (e) {
            ...
            var fr = function (e) {
              return (
                e && "object" === pr(e) && "[object Object]" === Object.prototype.toString.call(e)
              );
            };
            function dr() {
              for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
            ...
            function Dr(e) {
              var t,
                  ...
                  return (function (e) {
                    ...
                    var E,
                      ...
                      j = {
                        ...
                        ReverseHighlight: Ut(P),
                        ReverseSnippet: Jt(P),
                        Snippet: Qt(P),
                      };
                    return {
                      renderer: {
                        classNames: zt(er, null != r ? r : {}),
                        container: A,
                        getEnvironmentProps:
                          null != u
                            ? u
                        ...
                        panelContainer: d ? $t(O, d) : O.document.body,
                        ...
                        detachedMediaQuery:
                          null != y
                            ? y
                            : getComputedStyle(O.document.documentElement).getPropertyValue(
                ...
                v = a(function () {
                  return m.value.core.environment.matchMedia(m.value.renderer.detachedMediaQuery)
                    .matches;
                }),
                h = a(function () {
                  return Oe(
              ...
              function O(e) {
                ...
                (!(function (e) {
                  ...
                  (ke(
                    ...
                    Ie(n.loadingIndicator, {
                      hidden: "stalled" !== o.status,
                    }),
                    Ie(n.clearButton, { hidden: !o.query }));
                })(t),
                  (function (e, t) {
              ...
              function A() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                (u(),
                  (p.current = dr(m.value.renderer, m.value.core, { initialState: D.current }, e)),
                  c(),
                  o(),
              ...
              return (function (e) {
                ...
                return (
                  "function" == typeof t.addAlgoliaAgent &&
                    [].concat(Fr(ce), Fr(u)).forEach(function (e) {
                      var r = e.segment,
                        n = e.version;
            ...
            function Nr(e) {
              var t = Br({
                ...
                r = e.queries.map(function (e) {
                  return kr(kr({}, e), {}, { type: "facet" });
                });
              return t(kr(kr({}, e), {}, { queries: r }));
            }
            var Tr = Br({
              transformResponse: function (e) {
                return e.hits;
              ...
              function d(e, t) {
                ...
                return (
                  Object.keys(r).forEach(function (e) {
                    -1 ===
                      ["timeout", "headers", "queryParameters", "data", "cacheable"].indexOf(e) &&
                      (n[e] = r[e]);
                  }),
                  {
              ...
              function E(e) {
                var t = {
                  ...
                  add: function (e) {
                    ...
                    return (
                      -1 === t.value.indexOf(r) && (t.value = "".concat(t.value).concat(r)), t
                    );
                  },
                };
                return t;
                ...
                I = function (e) {
                  return function (t, n) {
                    var u = t.map(function (e) {
                      return r(r({}, e), {}, { params: F(e.params || {}) });
                    });
                ...
                var u,
                  o = {
                    ...
                    hostsCache: a({
                      caches: [
                        i({
                          key: "".concat("4.12.0", "-").concat(e),
                        }),
                        c(),
                      ],
                    }),
                    userAgent: E("4.12.0").add({
                      segment: "Browser",
                      version: "lite",
                    }),
            ...
            t.algoliasearchNetlify = function (e) {
              ...
              try {
                for (u.s(); !(t = u.n()).done; ) {
                  var l = t.value;
                  if (!r[l])
                    throw new Error("[algoliasearch-netlify] Missing mandatory key: ".concat(l));
                }
              } catch (e) {
                u.e(e);
              } finally {
                        ...
                        if (e && this.options.theme) {
                          ...
                          this.$themeNode = (function (e) {
                            ...
                            ".aa-Autocomplete, .aa-Panel, .aa-DetachedContainer {\n      "
                              ...
                              .concat(
                                t.mark && "--color-background: ".concat(t.background, ";"),
                                "\n      ",
                              )
                              .concat(
                              ...
                              .concat(
                                t.mark && "--color-source-icon: ".concat(t.colorSourceIcon, ";"),
                                "\n    }",
                              ),
                            this.$themeNode,
                          );
          ...
          920: (e, t, r) => {
            ...
            function u(e, t) {
              ...
              for (var o = 1; o < 7 && u < 3; ++o) {
                ...
                e.hierarchy[i] &&
                  ...
                  (u > 0 && r.push(" > "),
                  r.push((0, n.jsx)(t.Highlight, { hit: e.hierarchy, attribute: i }, void 0)),
                  ++u);
              }
              return r;
            }
            function o(e, t) {
              ...
              return o && "full" === o.matchLevel
                ? (0, n.jsx)(t.Snippet, { hit: e, attribute: "description" }, void 0)
                : i && "full" === i.matchLevel
                  ? (0, n.jsx)(t.Snippet, { hit: e, attribute: "content" }, void 0)
                  : o && !i
                    ? (0, n.jsx)(t.Snippet, { hit: e, attribute: "description" }, void 0)
                    : i
                      ? (0, n.jsx)(t.Snippet, { hit: e, attribute: "content" }, void 0)
          ...
          275: (e, t, r) => {
            ...
            function g(e) {
              ((!e.__d && (e.__d = !0) && i.push(e) && !b.__r++) || c !== u.debounceRendering) &&
              ...
              for (r.__k = [], f = 0; f < t.length; f++)
                if (
                  ...
                  if (
                    ((y.__ = r),
                    (y.__b = r.__b + 1),
                    null === (h = E[f]) || (h && y.key == h.key && y.type === h.type))
                  )
                    E[f] = void 0;
                  else
                    for (d = 0; d < C; d++) {
                  ...
                  (j(e, y, (h = h || l), u, o, i, a, c, p),
                    ...
                    (d = y.ref) &&
                      h.ref != d &&
                      (_ || (_ = []), h.ref && _.push(h.ref, null, y), _.push(d, y.__c || g, y)),
                    null != g
                      ? (null == b && (b = g),
            ...
            function O(e, t, r) {
              for (var n, u = e.__k, o = 0; u && o < u.length; o++)
                (n = u[o]) &&
                  ((n.__ = e),
                  (t = "function" == typeof n.type ? O(n, t, r) : A(r, n, n, u, n.__e, t)));
              return t;
            }
            ...
            function S(e, t, r, u, o, i, a, c) {
              ...
              if (null === h) m === v || (c && e.data === v) || (e.data = v);
                ...
                if (
                  ...
                  (f || p) &&
                    ((f && ((p && f.__html == p.__html) || f.__html === e.innerHTML)) ||
                ...
                c ||
                  ("value" in v &&
                    void 0 !== (y = v.value) &&
                    (y !== m.value || y !== e.value || ("progress" === h && !y)) &&
