...
{{< resource-table resource="books-introductory.yaml" type="book" >}}

### Otros

{{< resource-table resource="books-other.yaml" type="book" >}}

## Notas de clase

{{< resource-table resource="books-notes.yaml" type="book" >}}
